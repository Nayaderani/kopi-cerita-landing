...
function WhatsAppIcon({ className }: { className?: string }) {
  return (
    <svg
      ...
      aria-hidden="true"
    >
      <path d="M12.04 2C6.58 2 2.13 6.45 2.13 11.91c0 1.75.46 3.45 1.33 4.95L2.04 22l5.25-1.37A9.9 9.9 0 0012.04 22c5.46 0 9.91-4.45 9.91-9.91S17.5 2.09 12.04 2m6.59 14.23c-.27.77-1.35 1.4-1.89 1.49-.5.08-1.12.12-1.81-.13-.42-.15-1.34-.53-2.24-1.04-1.32-.74-2.19-1.49-2.99-2.68-.45-.67-.75-1.41-.85-2.13-.1-.72.05-1.37.37-1.85.19-.27.44-.42.7-.42h.5c.22 0 .46.08.61.34.23.4.82 1.57.89 1.68.07.11.11.24.03.39-.08.15-.15.24-.27.37-.12.13-.25.27-.36.36-.12.12-.24.25-.11.49.13.24.6 1.04 1.28 1.68.88.82 1.62 1.07 2.08 1.19.26.07.49-.05.64-.19.15-.14.62-.73.79-.98.17-.26.34-.21.57-.13.23.09 1.48.73 1.73.86.25.13.42.19.48.3.06.11.03.63-.12 1.25z" />
      <path d="M12.04 1.5C6.21 1.5 1.5 6.21 1.5 12.004c0 1.82.49 3.56 1.34 5.08L1.5 22.5l5.55-.34c1.44.75 3.07 1.16 4.79 1.16 5.79 0 10.5-4.71 10.5-10.5S17.79 1.5 12.04 1.5zm0 19.01c-1.49 0-2.93-.4-4.18-1.15l-.3-.18-3.31.2.43-3.23-.2-.34c-.87-1.52-1.33-3.27-1.33-5.08 0-5.65 4.59-10.24 10.24-10.24s10.24 4.59 10.24 10.24-4.59 10.24-10.24 10.24z" />
    </svg>
  );
}
